...
#特殊的页面bug
#http://bbs.tianya.cn/post-907-24984-3-1.shtml#204824#       
detail_f="E:/spyer_pro/crawl_data/detail_url.txt"
#f_out=open(detail_f,"w",encoding="utf8")
#get_tianya(page_num=1000,f_out=f_out)
run_spider(detail_f)
#f_out=open("E:/spyer_pro/crawl_data/tianya.txt",'w',encoding="utf8")
#get_all_detail(url="http://bbs.tianya.cn/post-907-24984-3-1.shtml",f_out=f_out,huifu_num=3)
